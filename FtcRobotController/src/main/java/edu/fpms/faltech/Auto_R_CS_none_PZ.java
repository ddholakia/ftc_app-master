...
DESCRIPTION:
    Autonomous program for Red alliance, starting in Corner Side and finishing in the Parking Zone.
TARGET SCORE:
    5
 ...
 */
public class Auto_R_CS_none_PZ extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.driveTrain.GoInches(54, .5, 5);
        robot.driveTrain.PivotTurn(-45, .5, 3);
